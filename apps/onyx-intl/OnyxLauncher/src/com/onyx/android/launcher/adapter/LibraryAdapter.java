...
public class LibraryAdapter extends GridItemBaseAdapter
{
    ...
    public LibraryAdapter(Context context, OnyxGridView gridView)
    {
        super(gridView);
...
//            textview_bookrack.setBackgroundResource(background_img_id);
            ...
            if (idx <= (this.getPaginator().getItemCount() - 1)) {
                ...
                LibraryAdapter.this.setShowMultipleCheckbox(ret_view, item_data);
