 ...
 *
 */
public class SearchResultAdapter extends GridItemBaseAdapter
{
    ...
    public SearchResultAdapter(Context context, OnyxGridView gridView)
    {
        super(gridView);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (this.getPageLayout().getViewMode() == GridViewMode.Detail) {
