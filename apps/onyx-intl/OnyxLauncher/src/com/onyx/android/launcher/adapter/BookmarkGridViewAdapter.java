...
public class BookmarkGridViewAdapter extends GridItemBaseAdapter
{
    ...
    public BookmarkGridViewAdapter(Context context, OnyxGridView gridView)
    {
        super(gridView);
...
//            textview_bookrack.setBackgroundResource(background_img_id);
            ...
            if (idx <= (this.getPaginator().getItemCount() - 1)) {
                ...
                BookmarkGridViewAdapter.this.setShowMultipleCheckbox(ret_view, item_data);
