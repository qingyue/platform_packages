...
public class OnyxCmsCenter
{
    ...
    public static boolean getLibraryItems(Context activity, SortOrder sortOrder, Collection<OnyxLibraryItem> result)
    {
        Cursor c = null;
        try {
            ...
            if (sortOrder == SortOrder.Name) {
                c = activity.getContentResolver().query(OnyxLibraryItem.CONTENT_URI, null, null, null, OnyxLibraryItem.Columns.NAME);
            }
            else {
                c = activity.getContentResolver().query(OnyxLibraryItem.CONTENT_URI, null, null, null, null);
            }
    ...
    public static boolean getLibraryItems(Context context, Collection<OnyxLibraryItem> result)
    {
        return getLibraryItems(context, SortOrder.None, result);
    }
    ...
    public static boolean getMetadatas(Context context, Collection<OnyxMetadata> result)
    {
        Cursor c = null;
        try {
            long time_start = System.currentTimeMillis();
            ...
            long time_point = time_start; 
            c = context.getContentResolver().query(OnyxMetadata.CONTENT_URI, null, null, null, null);
            long time_db_load = System.currentTimeMillis() - time_point;
    ...
    {
        Uri result = context.getContentResolver().insert(OnyxMetadata.CONTENT_URI, 
    ...
    {
        Uri row = Uri.withAppendedPath(OnyxMetadata.CONTENT_URI, String.valueOf(data.getId()));
    ...
    public static boolean getRecentReadings(Context context, Collection<OnyxMetadata> result)
    {
        Cursor c = null;
        try {
            long time_start = System.currentTimeMillis();
            ...
            long time_point = time_start; 
            c = context.getContentResolver().query(OnyxMetadata.CONTENT_URI, null, 
                    "(" + OnyxMetadata.Columns.LAST_ACCESS + " is not null) and (" + OnyxMetadata.Columns.LAST_ACCESS + "!='')", 
                    null, OnyxMetadata.Columns.LAST_ACCESS + " desc"); 
            long time_db_load = System.currentTimeMillis() - time_point;
    ...
    public static boolean getThumbnail(Context context, OnyxMetadata metadata, RefValue<Bitmap> result)
    {
        ...
        Cursor c = null;
        try {
            c = context.getContentResolver().query(OnyxThumbnail.CONTENT_URI, null, 
            ...
            if (c.moveToFirst()) {
                ...
                Uri row = Uri.withAppendedPath(OnyxThumbnail.CONTENT_URI, String.valueOf(data.getId()));
                InputStream is = null;
                try {
    ...
    public static boolean insertThumbnail(Context context, OnyxMetadata data, Bitmap thumbnail)
    {
        ...
        Uri result = context.getContentResolver().insert(OnyxThumbnail.CONTENT_URI, 
    ...
    private static void readLibraryItemCursor(Cursor c, Collection<OnyxLibraryItem> result)
    {
        if (c.moveToFirst()) {
    ...
    private static void readMetadataCursor(Cursor c, Collection<OnyxMetadata> result)
    {
        if (c.moveToFirst()) {
